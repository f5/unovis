    ...
    <>
      <VisXYContainer<XYDataRecord> data={data} margin={{ top: 5, left: 5 }}>
        ...
        <VisCrosshair
          ...
          y={accessors}
          enableSync={true}
          isActive={activeChart !== 'chart2' && activeChart !== 'chart3'}
      ...
      <VisXYContainer<XYDataRecord> data={data} margin={{ top: 5, left: 5 }}>
        ...
        <VisCrosshair
          ...
          y={accessors}
          enableSync={true}
          isActive={activeChart !== 'chart1' && activeChart !== 'chart3'}
          ...
          onCrosshairMove={(x) => onCrosshairMove(x, 'chart2')}
      ...
      <VisXYContainer<XYDataRecord> data={data3} margin={{ top: 5, left: 5 }}>
        ...
        <VisCrosshair
          ...
          y={[(d: XYDataRecord) => d.y]}
          enableSync={true}
          isActive={activeChart !== 'chart1' && activeChart !== 'chart2'}
