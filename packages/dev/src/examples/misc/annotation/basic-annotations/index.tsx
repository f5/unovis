...
import { AnnotationDatum, Scale } from '@unovis/ts'

// data
import { btcWeekly } from './btc-weekly'
const data: Array<[Date, number]> = btcWeekly
  .sort((a, b) => a[0] - b[0])
...
export const component = (): JSX.Element => {
  ...
  const annotations: AnnotationDatum[] = [
    {
      ...
      y: '92%',
      width: '50%',
      verticalAlign: 'bottom', // why donesn't work?
      content: [{
    ...
    },
    {
      ...
      content: 'Second peak, November 2013',
      subject: {
        x: () => xScale(peak2018Datum[0]),
        y: () => yScale(peak2018Datum[1]),
        connectorLineStrokeDasharray: '2 2',
        radius: 6,
      },
    },
  ...
  return (
    <VisXYContainer data={data} margin={{ top: 5, left: 5 }} xScale={xScale} yScale={yScale} yDomain={[0.05, 100000]} height={'50vh'}>
      ...
      <VisAnnotations data={annotations}/>
    </VisXYContainer>
  )
}
