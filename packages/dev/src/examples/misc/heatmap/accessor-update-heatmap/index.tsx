...
// Module scope, like the accessors above: adding a per-cell test id must not make the props unequal.
const attributes = {
  [VisHeatmapSelectors.cell]: {
    visHeatmapCellE2eTestId: (d: { row: number; column: number }) => `cell-r${d.row}-c${d.column}`,
  },
}
  ...
  return (
    <>
      <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 12 }}>
        ...
        <span data-testid='accessor-update-status' style={{ fontFamily: 'monospace' }}>{status}</span>
      </div>
