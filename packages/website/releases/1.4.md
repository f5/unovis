...
Check out _Annotations_'s [documentation](/docs/components/Annotations) and [gallery example](/gallery/view?collection=Auxiliary%20Components&title=Chart%20Annotations) to learn how to use it.
...
A number of features were added to _Graph_ in this [PR](https://github.com/f5/unovis/pull/322), including link curvature configuration, the ability to use custom SVGs as node icons, and support for longer link labels. Check out the [docs](https://unovis.dev/docs/components/Graph) for a deep dive into the latest enhancements or to explore the breadth of features Graph
has to offer.
