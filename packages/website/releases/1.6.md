...
Check out _Plotline_'s [documentation](/docs/components/Plotline), _Plotband_'s [documentation](/docs/components/Plotband), _Treemap_'s [documentation](/docs/components/Treemap), and _Rolling Pin Legend_'s [documentation](/docs/components/RollingPinLegend) with examples to learn how to use them.
...
- Configurable node and group spacing in Parallel layouts ([doc](/docs/components/Graph#fine-tuning-node-and-sub-group-spacing))
