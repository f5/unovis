...
Axis now automatically hides overlapping labels ([docs](/docs/components/Axis#hide-overlapping-ticks)) and supports label rotation ([docs](/docs/components/Axis#tick-label-rotation)).
