...
<div className='flex'>
  <div className='block'/>
  <XYWrapper {...defaultProps()} containerProps={{ height: 100 }} excludeTabs/>
  <div className='block'/>
</div>
...
<div className='flex'>
  <div className='block'/>
  <XYWrapper {...defaultProps()} containerProps={{ height: 100, margin: { left: 100, right: 100 }}} excludeTabs/>
  <div className='block'/>
</div>
...
<div className='flex'>
  <div className='block'/>
  <XYWrapper {...defaultProps()} containerProps={{ height: 100, padding: { left: 100, right: 100 }}} excludeTabs/>
  <div className='block'/>
</div>
...
<XYWrapper {...defaultProps('Scatter')} data={constraintData} xDomainMinConstraint={[1, undefined]} excludeTabs/>
