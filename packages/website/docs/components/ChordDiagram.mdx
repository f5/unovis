...
You can change the appearance of your circular chart with the following related properties from [_Donut_](/docs/components/Donut):
- [`angleRange`](/docs/components/Donut/#angle-range)
- [`cornerRadius`](/docs/components/Donut/#corner-radius)
- [`padAngle`](/docs/components/Donut/#pad-angle)
