...
The example below packs nine plotlines against a single y-value, forcing the **MAIN LINE** label to collide. Switch `labelOverflow` to see it displaced (*stack*) or hidden (*hide*).
