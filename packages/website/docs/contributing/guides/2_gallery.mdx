---
sidebar_label: Gallery Examples
---
...
### Svelte
1. Add your example's `svelte` fil path to the `imports` array in `src/svelte-gallery.svelte`
2. From the terminal, run the command
  ```bash
npm run gallery:svelte
  ```

### Angular
1. Import your angular module in `src/main.ts`
