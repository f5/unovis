...
feature to display them as mini pie charts. This is similar to the colorMap functionality in _Leaflet Map_.
...
export const colorMapData = ({
  points: [
    ...
    { id: 'TOK', latitude: 35.6762, longitude: 139.6503, healthy: 90, warning: 8, critical: 2 },
...
Each point will display as a pie chart where the segments represent the relative values of your data properties.
