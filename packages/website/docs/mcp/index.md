...
mdx:
  format: md
description: Generate Unovis charts from an MCP server
sidebar_position: 1
...
| [Interactive charts](./interactive.md) | The browser widget, self-contained HTML, iframe embedding, the MCP Apps extension |
