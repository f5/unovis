...
### Stacked Lines
You can also stack multiple lines using the `stacked` property. This combines well with [stacked Area](/docs/xy-charts/Area#stacked-areas).
<XYWrapper {...lineProps()} showContext="minimal" y={[d => d.y, d => d.y1, d => d.y2]} stacked />
