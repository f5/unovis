---
sidebar_class_name: vis-icon__grouped-bar
...
<XYWrapper {...defaultProps()} showContext="minimal" showAxes color={(d,i) => ['#04c0c7', '#5144d3', '#da348f'][i]}/>

### Orientation
_Grouped Bar_ supports horizontal and vertical orientation.
<XYWrapperWithInput {...defaultProps()} y={[d => d.y, d => d.y1, d => d.y2]} height={250} showAxes inputType="select" property="orientation" defaultValue="horizontal" options={["vertical", "horizontal"]}/>
