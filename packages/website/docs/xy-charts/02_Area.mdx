...
### Basic configuration
The _Area_ component has been designed to work together with _XY Container_. The minimal Area configuration looks like:
<Tabs groupId="framework">
  <TabItem value="react" label="React">
...
<AreaComponent y={[(d) => d.y, (d) => d.y1, (d) => d.y2]} className="visualization-container-div"/>
