...
## 🤖 Charts from an AI agent
`@unovis/mcp` is an MCP server that renders _Unovis_ charts locally — as SVG, PNG, an interactive HTML file, or
ready-to-paste component code for any of the supported frameworks. Connect it to Claude Code, Cursor or Codex and
ask for a chart. See the 🤖 [MCP Server](/docs/mcp) docs.
