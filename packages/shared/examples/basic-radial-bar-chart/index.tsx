...
const pathname = 'basic-radial-bar-chart'
const example: Example = {
  ...
  description: <div>A stacked-ring chart where each datum becomes a circular track and a colored bar fills it proportionally to the value.</div>,
