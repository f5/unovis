...
const getExpectancy = (d: AreaDatum) => d.age[yearScale(year.value)]
const getAreaColor = computed(() => (d: AreaDatum) => colorScale(getExpectancy(d)))
...
<template>
  <div class="topojson-map">
    ...
    <VisXYContainer :data="[0]" :height="70" :width="500">
      <VisStackedBar :x="0.5" :y="gradientSteps" :color="color" :orientation="Orientation.Horizontal" />
