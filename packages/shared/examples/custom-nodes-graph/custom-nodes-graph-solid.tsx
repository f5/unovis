...
const CustomNodesGraph = (): JSX.Element => {
  ...
  const [showLinkFlow, setShowLinkFlow] = createSignal(true)
  ...
  const handleShowLinkFlowChange = (checked: boolean) => {
    setShowLinkFlow(checked)
  }
      ...
      <div class={globalControlsContainer}>
        <label>
          <input
            ...
            onChange={(e) => handleShowLinkFlowChange(e.target.checked)}
          />
          Show Link Flow
        </label>
        <label>
