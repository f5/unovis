...
import { ref } from 'vue'
import { VisXYContainer, VisLine, VisAxis, VisPlotband } from '@unovis/vue'
  ...
  <div>
    <div class="controls">
      <fieldset>
        ...
        <label>from: <input type="range" min="0" max="9" step="0.1" v-model.number="yFrom" /> {{ yFrom.toFixed(1) }}</label>
        <label>to: <input type="range" min="0" max="9" step="0.1" v-model.number="yTo" /> {{ yTo.toFixed(1) }}</label>
      ...
      <fieldset>
        ...
        <label>from: <input type="range" min="0" max="14" step="0.1" v-model.number="xFrom" /> {{ xFrom.toFixed(1) }}</label>
        <label>to: <input type="range" min="0" max="14" step="0.1" v-model.number="xTo" /> {{ xTo.toFixed(1) }}</label>
