...
const pathname = 'plotbands-playground'
const example: Example = {
  ...
  pathname,
  title: 'Plotbands Playground',
  description: 'Interactive playground for plotband labels: tweak from/to, labelAutoPosition, and labelOverflow',
