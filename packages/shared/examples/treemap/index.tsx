...
const example: Example = {
  ...
  title: 'Treemap',
  description: <div>
    Data from <a href="https://informationisbeautiful.net/visualizations/the-billion-dollar-gram/" target="_blank">
      information is beautiful
    </a> (source: <em>The billion dollar gram</em>)
  </div>,
