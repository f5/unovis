...
export function createLabel<H extends Hierarchy> (selection: Selection<SVGElement, HierarchyRectangularNode<H>, SVGGElement, HierarchyRectangularNode<H>[]>): void {
  selection
    .style('opacity', 0)
    .attr('transform', d => {
...
export function updateLabel<H extends Hierarchy> (selection: Selection<SVGElement, HierarchyRectangularNode<H>, SVGGElement, HierarchyRectangularNode<H>[]>, width: number, duration: number): void {
