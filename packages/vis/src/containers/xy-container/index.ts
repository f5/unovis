...
export class XYContainer<Data> extends ContainerCore {
  config: XYContainerConfig<Data> = new XYContainerConfig()
  data: any
  private _clipPath: Selection<SVGGElement, object[], SVGGElement, object[]>
  private _clipPathId = guid()

  constructor (element, config?: XYContainerConfigInterface<Data>, data?) {
    super(element)
  ...
  get components (): XYComponentCore<Data>[] {
  ...
  updateContainer (containerConfig: XYContainerConfigInterface<Data>, preventRender?: boolean): void {
  ...
  updateComponents (componentConfigs: XYComponentConfigInterface<Data>[], preventRender?: boolean): void {
  ...
  update (containerConfig: XYContainerConfigInterface<Data>, componentConfigs?: XYComponentConfigInterface<Data>[], data?: any): void {
  ...
  updateScales<T extends XYComponentCore<Data>> (...components: T[]): void {
    const c = clean(components || this.components)
    this._updateScalesDomain(...c)
    this._updateScalesRange(...c)
  }

  _updateScalesDomain<T extends XYComponentCore<Data>> (...components: T[]): void {
  ...
  _updateScalesRange<T extends XYComponentCore<Data>> (...components: T[]): void {
  ...
  _setAutoMargin (axis: Axis<Data>): void {
