...
### Custom Cursor
Scatter also accepts the [cursor CSS property](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor) to enable different cursors when a user hovers over a point.
