...
### Multiple Lines
Line accepts an array of y accesors to display multiple lines:
```angular2html
...
// In the template:
<vis-line ... [color]="getColor"></vis-area>
```
...
```angular2html
<vis-line ... [lineDashArray]="[5]"></vis-area>
```
...
// In the template:
<vis-line ... [lineDashArray]="getDashes"></vis-area>
```
...
<vis-line ... events="events"></vis-area>
```
