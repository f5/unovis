...
export class VisXYLabelsComponent<Datum> implements XYLabelsConfigInterface<Datum>, AfterViewInit {
  ...
  private getConfig (): XYLabelsConfigInterface<Datum> {
    const { duration, events, attributes, x, y, id, color, xScale, yScale, scaleByDomain, xPositioning, yPositioning, labelFontSize, label, backgroundColor, cursor, labelTextBrightnessRatio, clustering, clusterLabel, clusterFontSize, clusterBackgroundColor, clusterCursor, clusterLabelColor } = this
    const config = { duration, events, attributes, x, y, id, color, xScale, yScale, scaleByDomain, xPositioning, yPositioning, labelFontSize, label, backgroundColor, cursor, labelTextBrightnessRatio, clustering, clusterLabel, clusterFontSize, clusterBackgroundColor, clusterCursor, clusterLabelColor }
