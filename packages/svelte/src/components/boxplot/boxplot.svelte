<script lang="ts">
  ...
  import { Boxplot, type BoxplotConfigInterface, type NumericAccessor } from '@unovis/ts'
  ...
  onMount(() => {
    component = new Boxplot<Datum>(config)
  ...
  // component accessor
  export function getComponent (): Boxplot<Datum> { return component }
