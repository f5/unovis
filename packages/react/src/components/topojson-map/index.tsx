...
export type VisTopoJSONMapRef<AreaDatum, PointDatum extends GenericDataRecord, LinkDatum> = {
...
function VisTopoJSONMapFC<AreaDatum, PointDatum extends GenericDataRecord, LinkDatum> (props: VisTopoJSONMapProps<AreaDatum, PointDatum, LinkDatum>, fRef: ForwardedRef<VisTopoJSONMapRef<AreaDatum, PointDatum, LinkDatum>>): ReactElement {
...
export const VisTopoJSONMap: (<AreaDatum, PointDatum extends GenericDataRecord, LinkDatum>(props: VisTopoJSONMapProps<AreaDatum, PointDatum, LinkDatum>) => JSX.Element | null) = React.memo(React.forwardRef(VisTopoJSONMapFC), arePropsEqual)
